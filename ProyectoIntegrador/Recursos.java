...
public class Recursos {
	...
	protected ArrayList<Recursos> listaDisponibles = new ArrayList<>();

	// lista de produtos no disponibles
	protected ArrayList<Recursos> listaNoDisponibles = new ArrayList<>();
	...
	// Al prestar enviamos un productode la lista de disponible a la de no
	// disponible
	...
	public void añadirDis(Recursos recursos) {
		Recursos r = recursos;
		r.cambiarDisponibilidad(recursos);
